...
#set initial voice prompt in seconds
timeout = 2
...
while user_quit_command is False:
    ...
    if command != LookupError:
        if command == TimeoutError:
            ...
            timeout = None
            command = AUI_sr.mic_input("no hurry, I'm here when you need me", timeout)
        ...
        #deprecte recipe function - google handles this now
        ...
        #        AUI_tts.say(AUI_recipe.recipe_full_report(selected_recipe))
            ...
            AUI_tts.say("ohh tha's a good one.  Let me check")
